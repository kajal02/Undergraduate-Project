...
///////////////////////////////////////////////adding here
$uid = $_SESSION['name'];
$fetchprodlist = mysqli_query($con , "select pid , product_name from `company_products_all` where company_name = '$uid'");
$ans = mysqli_fetch_all($fetchprodlist , MYSQL_BOTH);
...
foreach($ans as $a)
{
	...
	array_push($prodnames , $a[1]);
}
$tablename = $uid.'_history';
$fetchhistory = mysqli_query($con , "select pid,week,manufacturer from `$tablename`");
				...
				<div style="height: 50%; padding-top: 45px; float: down">
					<div style="height: 20%">
						<div class="email" style="float:left; width: 50%; padding-left:100px">
								<a  href="manufacturer_home.php">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp History &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
						</div>
						
						<div class="email"  style="float:left; width: 50%; padding-left:80px" >
							<a href="apply_ga.php">Apply genetic algorithm</a>
						</div>	
					</div>
					<div style="height: 20%">
						<div class="email"  style="float:left; width: 50%; padding-left:100px" >
							<a href="../SCIMOS/manufacturer_check_order.php">&nbsp&nbsp&nbsp Check Order &nbsp&nbsp&nbsp</a>
						</div>	
						<form id="History" method="post" action="History_download.php" style="padding-left:280px">
						<div class="email" style="float:left; width: 50%;  padding-left:80px">
								<a  href="#" id="History1">&nbsp&nbspDownload History&nbsp&nbsp </a>
						</div>
						</form>
					</div>
