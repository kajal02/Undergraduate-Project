				...
				<div style="height: 50%; padding-top: 45px; float: down">
					<div style="height: 20%">
						<div class="email" style="float:left; width: 50%; padding-left:100px">
								<a  href="supplier_home.php">&nbsp&nbsp&nbsp&nbsp History &nbsp&nbsp&nbsp&nbsp</a>
						</div>
						
						<div class="email" style="float:left; width: 50%; padding-left:100px">
								<a href="../SCIMOS/supplier_check_order.php">&nbsp Check Order </a>
						</div>
					...
					<div style="height: 20%">
						...
						<div class="email"  style="float:left; width: 50%; padding-left:80px" >
							<a href="supplier_place_order.php">&nbsp&nbsp&nbsp Place Order &nbsp&nbsp&nbsp</a>
						</div>	
						<form id="History" method="post" action="History_download.php" style="padding-left:180px">
						<div class="email" style="float:left; width: 50%; padding-left:100px ">
